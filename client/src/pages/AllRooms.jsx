...
const AllRooms = () => {
	...
	return (
		<div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px024">
			<div>
						...
						<div className="md:w-1/2 flex flex-col gap-2">
							...
							<div className="flex flex-wrap items-center mt-3 mb-6 gap-4">
								...
								{room.amenities.map((item, index) => (
									<div
										key={index}
										className="flex items-center gap-2 px-3 rounded-lg bg-[#f5f5ff]/70"
									>
										<img
				...
				>
					...
					<div className="px-5 pt-5">
						...
						{priceRAnges.map((range, index) => (
							<CheckBox key={index} label={`Ghs ${range}`} />
						))}
					</div>

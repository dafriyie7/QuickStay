...
// 			formData.append("pricePerNight", inputs.pricePerNight); // careful
// 			// converting amenities to array and keeping only enabled amenites
// 			const amenites = Object.keys(inputs.amenities).filter(
// 				(key) => inputs.amenities[key]
// 			);
// 			formData.append("amenities", JSON.stringify(amenites));
